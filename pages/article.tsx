  ...
  return (
    <MainLayout currentPage="article" key="main">
      ...
      <p>
        ...
        sentence above to give you a better understanding of the library and how
        to use it.
      </p>
      <p>
      ...
      />
      <StepByStepLinear />
      <p>This aproach is quite powerful and can be used to simulate physics:</p>
      <CodeBlock
        code={`
      ...
      <StepByStepMove />
      <p>
        This method is used by many frameworks and libraries out there but it's
        not the method used by <em>Humpf</em>.
      </p>
      <p>
        With <em>Humpf</em> your motion is represented as a continuous function
        of time, let's see what it means.
      </p>
      ...
      <p>To make things a bit more interesting we can use easing functions.</p>
      <h2>Easing functions</h2>
      <p>
        <a href="https://easings.net">Easing functions</a> are simple continuous
        function of time. You've probably already seen or even used one like{" "}
        <code>easeOutCubic</code>, <code>easeInOutQuad</code>, or{" "}
        <code>easeOutBounce</code>
      </p>
      <p>
        As I said, easing function are quite simple. As an example, here is what{" "}
        <code>easeInOutCubic</code> look like
      </p>
      <CodeBlock
        code={`
          function position(t: number): number {
      ...
      <p className="Note">
        How a Spring could correctly model motion on a screen ? Most of the time
        I just want to move things from one position to another, not bounce
        around.
      </p>
      <p>
      ...
      <DampingRatioToOne />
      <p>
        As you can see, it looks less and less like a spring and more like what
        we had with the <code>easeInOutCubic</code>. The main difference is that
        this time the curve is define by our spring equation !
      </p>
      <p className="Note">
